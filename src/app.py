...
higher_education = st.sidebar.radio('Wants Hígher Education?', ['Yes', 'No'])
...
# Mother job input
mother_job = st.sidebar.selectbox("Mother Job", ["House Wife", "Health", "Services", "Other", "Teacher"])

# Father job input
father_job = st.sidebar.selectbox("Father Job", ["At Home", "Health", "Services", "Other", "Teacher"])

# Reason for choosing school input
school_reason = st.sidebar.selectbox("Reason for choosing the school", ["Course", "Near to Home", "Reputation", "Other"])
...
if st.sidebar.button('Predict'):
    ...
    school_reason_home = 1 if school_reason == 'Near to Home' else 0
